...
import tarc.edu.selfcheckoutapp.ui.Home.ProfileFragment;
...
public class HomeActivity extends AppCompatActivity {
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    cartListRef.child("User View")
            .child(LoginPreferenceUtils.getPhone(HomeActivity.this)).addChildEventListener(new ChildEventListener() {
      @Override
    ...
    navigationView.setSpaceOnClickListener(new SpaceOnClickListener() {
      ...
      public void onCentreButtonClick() {
        Intent i = new Intent(HomeActivity.this, LiveBarcodeScanningActivity.class);
        startActivity(i);
