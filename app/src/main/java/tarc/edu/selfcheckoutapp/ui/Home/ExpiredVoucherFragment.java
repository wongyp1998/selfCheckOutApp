...
public class ExpiredVoucherFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_expired_voucher, container, false);

        recyclerView  = root.findViewById(R.id.expired_voucher_list);
...
//        long todayDate = cDate.getTime();

        FirebaseRecyclerOptions<Voucher> options = new FirebaseRecyclerOptions.Builder<Voucher>()
                .setQuery(dbRef.child("Discount").orderByChild("expiryDate").endAt(cDate.getTime()-1)
                        ,Voucher.class)
                .build();
        ...
        adapter = new FirebaseRecyclerAdapter<Voucher, VoucherViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull VoucherViewHolder holder, int position, @NonNull Voucher model)
            {
                ...
                holder.expired_view.setAlpha(0.3f);
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        intent.putExtra("expKey","expired");
